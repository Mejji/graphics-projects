/**
 * PortraitModularDrawing.java
 *
 * Auto-generated from SVG by Python (svgelements) — modular, rubric-friendly Java2D.
 * Features:
 *  - Painters: Face/Hair/Hand/Plush (+ Misc) with paint(Graphics2D, AffineTransform, toggles)
 *  - AffineTransform per element + top-level virtual-canvas scaling for HiDPI/resizing
 *  - Shapes: Rectangle2D, RoundRectangle2D, Ellipse2D, GeneralPath (lines/quads/cubics/close)
 *  - Fill rules (even-odd / non-zero), Stroke (width/cap/join/dash/miter), AlphaComposite
 *  - LinearGradientPaint / RadialGradientPaint (common <defs> cases)
 *  - Caching into BufferedImage; UI toggles for outlines/shading
 *
 * Compile/Run:
 *   javac PortraitModularDrawing.java
 *   java PortraitModularDrawing
 */
package alvear_portrait_4cse;
...
public class Alvear_Portrait_4CSE extends JPanel {
  ...
  public static void main(String[] args){
    SwingUtilities.invokeLater(() -> {
      Alvear_Portrait_4CSE panel = new Alvear_Portrait_4CSE();
